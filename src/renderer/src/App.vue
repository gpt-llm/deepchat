...
const A11yProvider = defineAsyncComponent(
  () => import('@/components/accessibility/A11yProvider.vue')
)
const A11yAnnouncer = defineAsyncComponent(
  () => import('@/components/accessibility/A11yAnnouncer.vue')
)
